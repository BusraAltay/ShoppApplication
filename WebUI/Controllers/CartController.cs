...
namespace WebUI.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                CartId = cart.Id,
                CartItem = cart.CartItem.Select(i => new CartItemModel()
                {
                    CartItemId = i.Id,
        ...
        private Payment PaymentProcess(OrderModel model)
        {
            ...
            options.ApiKey = "sandbox-t7vn5pSTvq0O87H1iwjhqYnnL7RVgZ9d";
            options.SecretKey = "sandbox-QqCkZOZMVpIhTxZQAIuK2zrOg1CLBJ4K";
